...
public class BtScanner_BtScanCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Covi.Droid.Features.Bluetooth.BtScanner+BtScanCallback, Covi.Android", BtScanner_BtScanCallback.class, __md_methods);
	}


	public BtScanner_BtScanCallback ()
	{
		super ();
		if (getClass () == BtScanner_BtScanCallback.class)
			mono.android.TypeManager.Activate ("Covi.Droid.Features.Bluetooth.BtScanner+BtScanCallback, Covi.Android", "", this, new java.lang.Object[] {  });
	}
